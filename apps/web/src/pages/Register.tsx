      ...
      <div className="mx-auto flex max-w-5xl flex-col gap-6 lg:flex-row lg:items-center">
        <div className="max-w-md rounded-3xl border border-slate-200 bg-white/80 p-8 shadow-sm backdrop-blur">
          ...
          <p className="mt-2 text-sm leading-7 text-slate-600">
            Join Sumi and start shaping your next manga project with a calmer workflow.
          </p>
        ...
        <div className="max-w-lg rounded-3xl border border-slate-200 bg-slate-900 p-8 text-white shadow-sm">
          <p className="text-sm uppercase tracking-[0.2em] text-slate-300">What’s waiting for you</p>
          <ul className="mt-6 space-y-4 text-sm leading-7 text-slate-300">
            <li className="rounded-2xl border border-white/10 bg-white/10 p-4">Create your first project in less than a minute.</li>
            <li className="rounded-2xl border border-white/10 bg-white/10 p-4">Keep your story planning clear and digestible.</li>
            <li className="rounded-2xl border border-white/10 bg-white/10 p-4">Bring your creative process together in one calm place.</li>
          </ul>
        </div>
      </div>
    </div>
